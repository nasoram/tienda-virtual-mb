...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "mb2" because\n';
 ...
 * "/mb2.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['mb2'].superdevmode = true;

  var expectedSuffix = '/mb2.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + mb2 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:mb2';
  var devModeSessionKey = '__gwtDevModeSession:mb2';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/mb2/mb2.nocache.js';
  ...
  $wnd.__gwt_activeModules['mb2'].canRedirect = true;
  $wnd.__gwt_activeModules['mb2'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/mb2?user.agent=' + ua + '&_callback=' + callback;
