 ...
 *
 */
mbApp.controllers = angular.module('mbControllers', ['ui.bootstrap']);
 ...
 *
 */
mbApp.controllers.controller('RootCtrl', function ($scope, $location, oauth2Provider) {
 ...
 *
 */
mbApp.controllers.controller('OAuth2LoginModalCtrl',
